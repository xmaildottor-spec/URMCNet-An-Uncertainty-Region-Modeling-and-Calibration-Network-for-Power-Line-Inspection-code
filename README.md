...
To facilitate performance comparisons for fellow researchers, we provide the visualization results generated by one of our random weight checkpoints below. 

> **Note:** The metrics reported in our tables represent the average of multiple runs. Additionally, because we incorporated random weather simulations into the VITLD dataset, our actual evaluation results on the original, unmodified dataset are slightly higher than the officially reported figures.

| Dataset | Link | Description |
| :--- | :--- | :--- |
| **VITLD** | [Download Link](https://drive.google.com/file/d/1ryoTB_SV-wuSfioL0Lk1udMb0b0UrQ-2/view?usp=sharing) | Visualization results, including various versions and different resolutions. |
| **TTPLA** | [Download Link](https://drive.google.com/file/d/1Jox123_Xmz3jGV1fiaYjhvwtrzQ5Cjwe/view?usp=sharing) | Visualization results, including various versions. |
