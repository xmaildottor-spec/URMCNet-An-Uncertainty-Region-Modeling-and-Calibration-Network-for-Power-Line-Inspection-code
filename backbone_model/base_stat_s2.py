...
from model.starnet import starnet_s2 
...
class TFNet(nn.Module):
    def __init__(self, n_class, mode=True, pretrained=True):
        ...
        self.model1 = starnet_s2(pretrained=pretrained)
        self.model2 = starnet_s2(pretrained=pretrained)
    ...
    def forward(self, input_RGB, input_T):
        ...
        m1 = self.fuse1(r1 + t1)   # 24
        m2 = self.fuse2(r2 + t2)   # 48
        m3 = self.fuse3(r3 + t3)   # 96
        m4 = self.fuse4(r4 + t4)   # 192
